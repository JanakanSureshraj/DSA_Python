...
class BST:
    ...
    # The following two could be applied to any binary trees in general:
    ...
    # BST's (wrapper) height function (note that this function could be called on a BT as well!)
    def height(self):
    ...
    # O(log(n)) Solution (in case of a balanced BST, othrewise could still be as bad as O(n):)
